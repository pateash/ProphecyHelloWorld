...
def main():
    ...
    try:
        ...
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/customer_orders_parquet_target", config = Config)
    except :
        
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/customer_orders_parquet_target")
